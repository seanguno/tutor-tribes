            ...
            <div class="header">
                ...
                <div class="instructions">
                    ...
                    <ul>
                        ...
                        <li><strong>Collapsible Sidebar:</strong> Click the ◀ button to collapse/expand the sidebar</li>
...
with open('tutor_overlap_report_v5.html', 'w', encoding='utf-8') as f:
    f.write(html_content)

print("✅ Enhanced analysis with collapsible sidebar completed!")
...
print("   • tutor_overlap_report_v5.html (Enhanced HTML with collapsible sidebar)")
print("\nKey improvements:")
print("• Collapsible sidebar (click ◀ button)")
print("• All sections start closed by default")
print("• Navigation automatically opens sections")
print("• Expand/Collapse all buttons")
