...
# Create HTML report with sticky sidebar TOC, collapsible sections, and scroll-to-top
html_content = """
<!DOCTYPE html>
<html lang="en">
<head>
...
for person in sorted(results.keys()):
    html_content += f'                <li class="toc-item"><a href="#{person.replace(" ", "-")}" onclick="scrollToSection(\'{person.replace(" ", "-")}\')">{person}</a></li>\n'
        ...
        <div class="main-content">
            <div class="header">
                ...
                <div class="instructions">
                    ...
                    <ul>
                        <li><strong>Sidebar Navigation:</strong> Use the left sidebar to jump to any tutor</li>
                        <li><strong>Collapsible Sections:</strong> Click on any tutor header to collapse/expand</li>
...
with open('tutor_overlap_report_v4.html', 'w', encoding='utf-8') as f:
...
print("   • tutor_overlap_report_v4.html (Enhanced HTML with sticky sidebar)")
print("\nKey improvements:")
print("• Sticky sidebar table of contents")
print("• Collapsible tutor sections")
print("• Scroll-to-top button")
print("• Enhanced CSV with missing classes")
