...
# Create HTML report with embedded CSS and improved accessibility
html_content = """
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    <div class="container">
        ...
        <div class="instructions">
            ...
            <ul>
                <li><strong>Table of Contents:</strong> Click any tutor name to jump to their section</li>
